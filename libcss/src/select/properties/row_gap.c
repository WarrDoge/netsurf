...
{
	/* CSS Box Alignment says normal computes to zero for row-gap.
	 * column-gap keeps the 1em that CSS Multicol gives it.
	 */
	return set_row_gap(state->computed, CSS_ROW_GAP_NORMAL,
			INTTOFIX(0), CSS_UNIT_PX);
}
